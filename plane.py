...
class Plane(object):
    ...
    def __init__(self, normal_vector=None, constant_term=None):
        '''initializes plane; takes normal vector and constant term; sets
    ...
    def is_parallel_to(self, p):
        '''takes two planes and checks parallelism'''
    ...
    def __eq__(self, p):
        '''takes two planes and checks whether they are the same plane'''
    ...
    def set_basepoint(self):
        '''takes plane and returns basepoint'''
        try:
            n = self.normal_vector
